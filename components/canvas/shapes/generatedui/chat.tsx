...
type Props = { generatedUID: string; isOpen: boolean; onClose: () => void };

export const ChatWindow = ({ generatedUID, isOpen, onClose }: Props) => {
  const {
    inputValue,
    setInputValue,
    scrollAreaRef,
    ...
    handleClearChat,
    chatState,
  } = useChatWindow(generatedUID, isOpen);
  ...
  return (
    ...
    >
      <div className="flex items-center p-4 border-b border-white/[0.12]">
