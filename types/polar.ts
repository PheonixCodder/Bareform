...
export const extractOrderLike = (data: unknown): PolarOrder => {
  ...
  const billing_reason = d.billing_reason as string | null;
  const subscription_id = d.subscription_id as string | null;
  const customer = d.customer as PolarCustomer | null;
  const customer_id = d.customer_id as string | null;
